  ...
  <div class="tw-flex tw-justify-center tw-flex-wrap tw-gap-[20px] tw-mb-[40px]">
    ...
    >
      ...
      <div class="tw-flex tw-items-center tw-justify-between">
        ...
        <span class="tw-bg-[#24B2E3] tw-text-[12px] tw-text-white tw-text-xs tw-font-medium tw-py-[12px] tw-px-[16px] tw-rounded-[124px]">
      ...
      <div class="p-4 tw-justify-between tw-flex tw-flex-col">
        <h4 class="tw-text-gray-500 tw-text-sm mb-1">{{ product.organization }}</h4>
        ...
        <div class="tw-py-[12px] tw-flex-wrap tw-gap-[7px] tw-border-t tw-border-[#F4F4F4] tw-border-b tw-flex">
          <span v-for="tag in product.geographicCoverage" :key="tag" class="tw-text-[12px] tw-bg-gray-200 tw-text-gray-700 tw-px-[14px] tw-py-[12px] tw-rounded-[124px]">
            {{ tag }}
          </span>
        </div>
